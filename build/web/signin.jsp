    ...
    <div class="android-be-together-section">
      <div class="formulario-cadastro color-orange"> 
        <div class="mdl-grid center-items color-orange">
          ...
          <form method="POST" name="cadastroForm" class="" onsubmit="return verificarCamposCadastro()">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label col-tam ">
              <input class="mdl-textfield__input color-white" type="text" name="Telefone" pattern = "-?[0-9]*(\.[0-9]+)?" id="sample3">
