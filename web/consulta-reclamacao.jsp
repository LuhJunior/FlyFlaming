                ...
                <div class="mdl-grid center-items color-orange">
                    ...
                    <form method="POST" name="reclamacaoForm" class="" onsubmit="return verificarCamposReclamacao()">
                        ...
                        <div class="toolbar-section">
                            <button class="mdl-button mdl-js-button mdl-button--raised mdl-color--accent mdl-color-text--accent-contrast mdl-js-ripple-effect margin-top" type="submit" name="submit">Consultar reclamação</button>
                        </div>
                    </form>
                </div>
            </div>
